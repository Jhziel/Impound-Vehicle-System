...
<?php
$sql = $conn->query("SELECT * FROM `staff_privellages` WHERE `staff_unique_id`= '{$_settings->userdata('unique_id')}'");
        ...
        <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
          ...
          <nav class="mt-4">
            <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item dropdown <?php echo $offense_records_check ? '' : 'd-none'; ?>">
              ...
              <li class="nav-item dropdown <?php echo $impound_vehicle_check ? '' : 'd-none'; ?>">
                <a href="<?php echo base_url ?>admin/?page=impound_vehicle" class="nav-link nav-impound_vehicle">
              ...
              <li class="nav-item dropdown <?php echo $archieve_data_check ? '' : 'd-none'; ?>">
              ...
              <li class="nav-item <?php echo $archieve_data_check ? '' : 'd-none'; ?>">
                <a href="#" class="nav-link">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="<?php echo base_url ?>admin/?page=drivers_archieve" class="nav-link nav-drivers_archieve">
                      <i class="nav-icon fas fa-id-card"></i>
                      <p>Drivers</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?php echo base_url ?>admin/?page=enforcers_archieve" class="nav-link nav-enforcers_archieve">
                      <i class="nav-icon fas fa-user-nurse"></i>
                      <p>Enforcers</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?php echo base_url ?>admin/?page=offense_records_archieve" class="nav-link nav-offense_records_archieve">
                      <i class="nav-icon fas fa-file-alt"></i>
                      <p>Offense Records</p>
                    </a>
                  </li>
