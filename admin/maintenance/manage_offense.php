...
<div class="card card-outline card-info">
	<div class="card-header">
		...
		<div class="card-tools">
			...
			<a href="?page=maintenance/offenses" class="btn btn-outline-secondary mr-2">
	...
	<div class="card-body">
		<form action="" id="offense-form">
			...
			<div class="form-group col-4">
				...
				<input name="fine" id="fine" type="number" step="any" class="form-control form " value="<?php echo isset($fine) ? $fine : ''; ?>" />
			</div>
			<div class="form-group col-4">
