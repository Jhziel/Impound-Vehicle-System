...
<div class="container-fluid">
    ...
    <div class="border border-dark px-2 py-2" id="print_out">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="d-flex w-max-100">
                                ...
                                <p class="col-md-auto border-bottom border-dark w-50"><b><?php echo $name ?></b></p>
                            </div>
                            <div class="row justify-content-between  w-max-100">
                                <div class="col-6 d-flex w-max-100">
                            ...
                            <div class="row justify-content-between w-max-100">
                                <div class="col-6 w-max-100 d-flex">
                                    <label class="float-left w-auto whitespace-nowrap">Province:</label>
                                    <p class="col-md-auto border-bottom border-dark w-100"><b><?php echo $province ?></b></p>
                                </div>
                                <div class="col-6 w-max-100 d-flex">
                                    <label class="float-left w-auto whitespace-nowrap">Municipality:</label>
                                    <p class="col-md-auto border-bottom border-dark w-100"><b><?php echo $municipality ?></b></p>
                                </div>
                            </div>
                            <div class="d-flex w-max-100">
                                <label class="float-left w-auto whitespace-nowrap">Barangay:</label>
                                <p class="col-md-auto border-bottom border-dark w-50"><b><?php echo $barangay ?></b></p>
                            </div>
                            <div class="d-flex w-max-100">
                                <label class="float-left w-auto whitespace-nowrap">House No:</label>
        ...
        <table class='table table-stripped px-4'>
            ...
            <tbody>
                <?php
                $olist = $conn->query("SELECT i.*,o.code,o.name FROM `offense_items` i inner join `offenses` o on i.offense_id = o.id where i.driver_offense_id in (SELECT id FROM `offense_list` where driver_id = '{$driver_id}') order by unix_timestamp(i.date_created) desc  ");
                if ($conn->error) {
                    echo $conn->error . "\n";
                }
