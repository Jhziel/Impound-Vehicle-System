            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form " id="last_name_Input" required name="lastname" value="<?php echo isset($lastname) ? $lastname : '' ?>">
                        <div class="invalid-feedback">
...
<script src="/../traffic_offense/assets/js/addDriverModal.js"></script>