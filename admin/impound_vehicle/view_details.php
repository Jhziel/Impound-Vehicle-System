...
if (isset($_GET['id']) && $_GET['id'] > 0) {
    $qry = $conn->query("SELECT i.*, p.parking_location, p.availability, p.position, p.impound_no
FROM impound_vehicle_list i
LEFT JOIN parking_number p ON i.impound_no = p.impound_no; ");
